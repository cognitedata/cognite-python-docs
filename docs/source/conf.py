...
htmlhelp_basename = "cognite-pythondoc"
...
latex_documents = [(master_doc, "cognite-python.tex", "cognite-python Documentation", "Cognite", "manual")]
...
man_pages = [(master_doc, "cognite-python", "cognite-python Documentation", [author], 1)]
